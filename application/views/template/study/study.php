			...
			<div class="container">
				<div class="row">
					<div class="col-md-9 col-lg-9 col-xl-9">
						<img src="<?php echo base_url() ?>external/img/civil_life1.jpg" class="img-responsive" style="width: 100%;" alt=""/>
					</div>
						...
						<div class="fondo_sponsors">
							...
							<?php 
				                ...
				                if ( count($listado_panel_centro_sponsors) > 0 ) 
				                {
				                  ...
				                  {
				                    echo '<img src="'.base_url().'uploads/study/panel_derecha/sponsors/'.$row->imagen.'" class="img-responsive" style="width: 100%;" />';
				                  }
				                }else{
				                  echo "";
				                }
								...
								foreach ($pagin as $row) 
								{
									?>
										<div class="fondo_starting">
											...
											<!--<div class="fondo_imagen">
												<img src="<?php echo base_url() ?>uploads/study/panel_centro/<?php echo $row->imagen; ?>" class="img-responsive" style="width: 100%;" alt=""/>
											</div><br />!-->
											<?php 
												if ($row->link == true)
												{
													...
													?>
														<div class="fondo_imagen">
															<img src="<?php echo base_url() ?>uploads/study/panel_centro/<?php echo $row->imagen; ?>" alt="" class="img-responsive" style="width: 100%;">
														</div><br />
													<?php
												}
											?>
