...
<div class="box-header">
	<h3 class="box-title">Add New Interest</h3>
</div>
	...
	<div class="box-body">
		<form class="form-horizontal" method="POST" id="formulario">
			<div class="form-group">
				...
				<div class="col-sm-5">
					<input type="text" class="form-control" id="titulo" placeholder="Interest" name="title">
