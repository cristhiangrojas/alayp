      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-info">
            ...
            <div class="box-body">
              <form action="<?php echo base_url(); ?>administrador/modulos/menu/starting_business/starting_business/procesar_sponsors" id="agregar_articulo" method="POST" class="form-horizontal" enctype="multipart/form-data">
              ...
              <?php 
                ...
                if ( count($listado_panel_centro_sponsors) > 0 ) 
                {
                  ...
                  {
                    echo '<img src="'.base_url().'uploads/starting_business/panel_derecha/sponsors/'.$row->imagen.'" class="img-responsive" />';
                  }
                }else{
                  echo "";
                }
