      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            <form action="<?php echo base_url(); ?>administrador/modulos/menu/starting_business/starting_business/procesar_edit_panel_centro" id="agregar_articulo" method="POST" class="form-horizontal" enctype="multipart/form-data">

              <div class="box-body">

                <input type="hidden" class="form-control" name="id_starting_business_panel_centro" id="id_starting_business_panel_centro" value="<?php echo $row->id_starting_business_panel_centro; ?>" autocomplete="off">
              ...
              <div class="box-footer">
                <a href="<?php echo site_url('administrador/modulos/menu/starting_business/starting_business/panel_centro') ?>" id="" class="btn btn-default pull-left"><i class="fa fa-arrow-left"></i> Atras</a>
