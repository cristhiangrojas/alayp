      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-success">
            <form action="<?php echo base_url(); ?>administrador/modulos/menu/starting_business/starting_business/procesar_agregar_panel_centro" id="agregar_articulo" method="POST" class="form-horizontal" enctype="multipart/form-data">
