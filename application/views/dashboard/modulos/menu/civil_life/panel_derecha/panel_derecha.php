<div class="content-wrapper">
  <section class="content-header">
      <h1>Civic Life | Panel Derecha</h1>
      <ol class="breadcrumb">
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box box-info">
            ...
            <div class="box-body">
              <form action="<?php echo base_url(); ?>administrador/modulos/menu/civil_life/civil_life/procesar_sponsors" id="agregar_articulo" method="POST" class="form-horizontal" enctype="multipart/form-data">
               ...
               if ( count($listado_panel_centro_sponsors) > 0 ) 
                {
                  ...
                  {
                    echo '<img src="'.base_url().'uploads/civil_life/panel_derecha/sponsors/'.$row->imagen.'" class="img-responsive" />';
                  }
                }else{
                  echo "";
                }
