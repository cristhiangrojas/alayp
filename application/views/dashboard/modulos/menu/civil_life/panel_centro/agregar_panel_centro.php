<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Civic Life</li>
        <li class="active">Nuevo Civic Life</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-success">
            <form action="<?php echo base_url(); ?>administrador/modulos/menu/civil_life/civil_life/procesar_agregar_panel_centro" id="agregar_articulo" method="POST" class="form-horizontal" enctype="multipart/form-data">
