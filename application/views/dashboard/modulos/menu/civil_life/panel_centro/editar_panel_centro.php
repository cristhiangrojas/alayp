      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            <form action="<?php echo base_url(); ?>administrador/modulos/menu/civil_life/civil_life/procesar_edit_panel_centro" id="agregar_articulo" method="POST" class="form-horizontal" enctype="multipart/form-data">

              <div class="box-body">

                <input type="hidden" class="form-control" name="id_civic_life_panel_centro" id="id_civic_life_panel_centro" value="<?php echo $row->id_civic_life_panel_centro; ?>" autocomplete="off">
              ...
              <div class="box-footer">
                <a href="<?php echo site_url('administrador/modulos/menu/civil_life/civil_life/panel_centro') ?>" id="" class="btn btn-default pull-left"><i class="fa fa-arrow-left"></i> Atras</a>
