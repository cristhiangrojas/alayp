<div class="content-wrapper">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li>Panel Centro</li>
        <li class="active">Nuevo Panel Centro</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-success">
            <form action="<?php echo base_url(); ?>administrador/modulos/menu/migration_visas/migration_visas/procesar_agregar_panel_centro" id="agregar_articulo" method="POST" class="form-horizontal" enctype="multipart/form-data">
            ...
            <?php
                ...
                if ($this->session->flashdata('agregar_articulo')==true) 
                {
                  ?>
                      <div class="alert alert-success" role="alert">
                        <?=$this->session->flashdata('agregar_articulo')?>
                      </div>
                    <?php
                }
