      ...
      <div class="row">
        <div class="col-xs-6">
          <div class="box box-info">
            ...
            <div class="box-body">
              <form action="<?php echo base_url(); ?>administrador/modulos/menu/newsfeed/newsfeed/procesar_sponsors" id="agregar_articulo" method="POST" class="form-horizontal" enctype="multipart/form-data">
              ...
              <?php 
                ...
                if ( count($listado_panel_centro_sponsors) > 0 ) 
                {
                  ...
                  {
                    echo '<img src="'.base_url().'uploads/newsfeed/panel_derecha/sponsors/'.$row->imagen.'" class="img-responsive" />';
                  }
                }else{
                  echo "";
                }
        ...
        <div class="col-xs-6">
          <div class="box box-info">
            <div class="box-header">
              <h3 class="box-title">Agregar Connect</h3>
            </div>
            <div class="box-body">
              <form action="<?php echo base_url(); ?>administrador/modulos/menu/newsfeed/newsfeed/procesar_connect" id="agregar_articulo" method="POST" class="form-horizontal" enctype="multipart/form-data">
              ...
              <?php 
                ...
                if ( count($listado_panel_centro_connect) > 0 ) 
                {
                  ...
                  {
                    echo '<img src="'.base_url().'uploads/newsfeed/panel_derecha/connect/'.$row->imagen.'" class="img-responsive" />';
                  }
                }else{
                  echo "";
                }
            ...
            <?php
                if ($this->session->flashdata('edit_panel_derecha_connect')==true) 
                {
                  ?>
                      <div class="alert alert-success" role="alert">
                        <?=$this->session->flashdata('edit_panel_derecha_connect')?>
                      </div>
                    <?php
                }

                if ($this->session->flashdata('error_imagen1')==true) 
                {
                  ?>
                    <div class="alert alert-danger" role="alert">
                      <?=$this->session->flashdata('error_imagen1')?>
                    </div>
                  <?php
                }
            ?>
