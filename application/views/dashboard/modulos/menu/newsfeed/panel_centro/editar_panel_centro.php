      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-info">
            <form action="<?php echo base_url(); ?>administrador/modulos/menu/newsfeed/newsfeed/procesar_edit_panel_centro" id="agregar_articulo" method="POST" class="form-horizontal" enctype="multipart/form-data">

              <div class="box-body">

                <input type="hidden" class="form-control" name="id_newsfeed_panel_centro" id="id_newsfeed_panel_centro" value="<?php echo $row->id_newsfeed_panel_centro; ?>" autocomplete="off">
