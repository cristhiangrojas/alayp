	...
	<div class="box-body">
		<form class="form-horizontal" method="POST" id="formulario">
			<div class="form-group">
				<label for="inputEmail3" class="col-sm-2 control-label">Industry</label>
				<div class="col-sm-5">
					<input type="text" class="form-control" id="titulo" placeholder="Industry" name="title">
