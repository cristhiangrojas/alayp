      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-success">
            <form action="<?php echo base_url(); ?>administrador/modulos/menu/study/study/procesar_agregar_newsfeed" id="agregar_articulo" method="POST" class="form-horizontal" enctype="multipart/form-data">
                  ...
                  if ($row->imagen == true)
                  {
                    ?>
                      <div class="form-group">
                        ...
                        <div class="col-sm-10">
                          <?php 
                            echo '<img src="../../../../../uploads/study/panel_centro/'.$row->imagen.'" class="img-responsive" />';
                          ?>
                        </div>
                      </div> 
                    <?php 
